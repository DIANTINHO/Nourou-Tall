...
?>
<?php
    if(isset($_POST['prenom'],$_POST['nom'],$_POST['mdp'],$_POST['date'],$_POST['lieu'],$_POST['adresse'],$_POST['matiere'],$_POST['tele'])){
        //insertion des informations
        $insertion="INSERT INTO professeur(prenom,nom,adresse,date_naissance,lieu_naissance,telephone,matiere) VALUES (:prenom,:nom,:adresse,:date_naissance,:lieu_naissance,:telephone,:matiere)";
        $professeur=$pdo->prepare($insertion);
        $professeur=$professeur->execute([
            ':prenom'=>$_POST(['prenom']),
            ':nom'=>$_POST(['nom']),
...
<body>
    ...
    <form action="index.php" method="POST">
        ...
        <div class="input-with-icon">
            ...
            <input type="text" name="prenom" class="champ" placeholder="Prenom du professeur" required>
        </div>
        <label for="nom">Nom du professeur:</label>  
        <div class="input-with-icon">
            <img src="../images/login.png" alt="Icone login" class="input-icon">
            <input type="text" name="nom" class="champ" placeholder="Nom du professeur" required>
        </div>
        ...
        <label for="matiere">Matiere du professeur</label>
        <input type="tel" name="matiere" placeholder="Indiquez la matiere que vous enseignez" required>
        
        <label for="tele">Numero de telephone du professeur</label>
        <div class="input-with-icon">
