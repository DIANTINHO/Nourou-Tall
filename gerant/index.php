...
<?php
    if(isset($_POST['prenom'],$_POST['nom'],$_POST['mdp'],$_POST['date'],$_POST['lieu'],$_POST['adresse'],$_POST['tele'])){
        ...
        $insertion="INSERT INTO gerant(prenom,nom,adresse,date_naissance,lieu_naissance,telephone) VALUES (:prenom,:nom,:adresse,:date_naissance,:lieu_naissance,:telephone)";
        $gerant=$pdo->prepare($insertion);
        $gerant=$gerant->execute([
            ':prenom'=>$_POST(['prenom']),
            ':nom'=>$_POST(['nom']),
...
<body>
    ...
    <form action="index.php" method="POST">
        <label for="prenom">Prenom du gerant:</label>  
        <div class="input-with-icon">
            <img src="../images/login.png" alt="Icone login" class="input-icon">
            <input type="text" name="prenom" class="champ" placeholder="Prenom du gerant" required>
        </div>
        <label for="nom">Nom du gerant:</label>  
        <div class="input-with-icon">
            <img src="../images/login.png" alt="Icone login" class="input-icon">
            <input type="text" name="nom" class="champ" placeholder="Nom du gerant" required>
        </div>
        ...
        <label for="tele">Numero de telephone du gerant</label>
        <div class="input-with-icon">
